<template>
    <div class="game-area">
        ...
        <h4 class="description">
            Açık kartlardan birini seçtikten sonra, kapalı olan karta tıklayın
        </h4>
        <div class="container">
...
/************ Açık Kart animasyonları için Transition class tanımları  ************/
.rotate-all-enter {
}
...
/************ Kapalı Kart animasyonları için Transition class tanımları  ************/
.rotate-enter {
}
.rotate-enter-active {
